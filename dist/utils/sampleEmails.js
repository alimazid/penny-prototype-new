...
exports.sampleEmailGenerator = exports.SampleEmailGenerator = void 0;
...
class SampleEmailGenerator {
    ...
    generateSampleEmails(count = 20) {
        ...
        logger_1.logger.info(`Generated ${emails.length} sample emails for testing`);
        return emails;
    }
    generateEmailByType(type) {
...
Bank of America Customer Service`,
    ...
    generateCreditCardEmail(id, date) {
...
View your statement online at chase.com`,
    ...
    generateInvestmentEmail(id, date) {
...
${merchant} Team`,
    ...
    generateSubscriptionEmail(id, date) {
...
Fidelity Tax Services`,
    ...
    generateInsuranceEmail(id, date) {
        return {
            id,
...
America's Largest Mortgage Lender`,
    ...
    generateNonFinancialEmail(id, date) {
        const subjects = [
...
Newsletter Team`,
    ...
    generateSpanishQikEmail(id, date) {
...
Equipo Qik`,
    ...
    generateSpanishNotificacionEmail(id, date) {
...
Banco Card Dominicano`,
    ...
    generateSpanishBHDEmail(id, date) {
...
exports.SampleEmailGenerator = SampleEmailGenerator;
// Export singleton instance
exports.sampleEmailGenerator = new SampleEmailGenerator();
//# sourceMappingURL=sampleEmails.js.map